    ...
    <div className="space-y-3">
      ...
      <div className="relative">
        <label className="block text-sm font-medium text-gray-700 mb-2">
          Pantone Code (TCX)
          <span className="text-xs text-gray-500 ml-2 font-normal">Textile industry standard</span>
        </label>
        <div className="relative">
          <input
            ref={pantoneInputRef}
      ...
      <div className="relative">
        ...
        <div className="flex gap-2">
          ...
          <button
            type="button"
            onClick={startCamera}
            className="px-4 py-2.5 bg-brand-blue text-white rounded-lg font-medium hover:bg-brand-blue/90 focus:ring-2 focus:ring-brand-blue/20 transition-all flex items-center gap-2"
          >
        ...
        <p className="mt-1 text-xs text-gray-500">
          Type a color name, click the color box to pick manually, or use the camera to capture from fabric
        </p>
      </div>
