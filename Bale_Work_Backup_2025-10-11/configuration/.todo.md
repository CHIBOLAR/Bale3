...
### Phase 2B: Magic Link Two-Tier System (IN PROGRESS)
- [ ] Database changes
  - [ ] Create migration for is_demo flags
  - [ ] Create shared demo company with warehouse
  - [ ] Populate demo data (products, partners, orders)
  - [ ] Create RLS policies for demo users
- [ ] Auth hook modification
  - [ ] Update validate-signup to allow signups without invite
  - [ ] Redeploy Edge Function
  - [ ] Test demo and invite flows
- [ ] Callback handler update
  - [ ] Check for invite presence
  - [ ] Assign to demo company if no invite
  - [ ] Create new company if invite exists
  - [ ] Set is_demo flag correctly
- [ ] Homepage with magic link
...
- [ ] Invite request system
  ...
  - [ ] Create API route for submission
  - [ ] Save to invite_requests table
  - [ ] Success confirmation
- [ ] Admin invite management
  - [ ] List pending invite requests
  - [ ] Approve/Reject actions
  - [ ] Generate invite code on approval
...
- [ ] Testing & QA
  ...
  - [ ] Test invite request flow
  - [ ] Test invite approval flow
  - [ ] Test official signup flow
  - [ ] Test edge cases
