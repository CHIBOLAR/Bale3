...
import { signInWithGoogle, signUpWithEmailOTP, verifyOTP } from '@/lib/auth/providers';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-cream via-white to-blue-50 px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Start managing your fabric inventory today</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link href="/login" className="font-semibold text-brand-blue hover:text-blue-700">
              Log in
            </Link>
          </div>
        </div>
