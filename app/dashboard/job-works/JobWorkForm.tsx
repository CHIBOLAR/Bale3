...
export default function JobWorkForm({ partners, warehouses, salesOrders }: JobWorkFormProps) {
            ...
            <div className="border-t border-gray-200 pt-6">
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-blue-900 font-medium text-sm mb-1">Next Steps</p>
                    <p className="text-blue-800 text-sm leading-relaxed">
                      After creating this job work, you'll need to:
                    </p>
                    <ul className="mt-2 space-y-1 text-blue-800 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="text-blue-600 mt-0.5">1.</span>
                        <span><strong>Dispatch raw materials</strong> - Select stock units with QR codes to send to the vendor</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-blue-600 mt-0.5">2.</span>
                        <span><strong>Receive finished goods</strong> - Record when finished goods are received back with QR codes</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div>
                ...
                >
                  <option value="">None (Optional)</option>
                  {partners.filter(p => p.partner_type === 'Agent').map((agent) => (
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Select an agent if one is facilitating this job work
                </p>
              </div>
            </div>
